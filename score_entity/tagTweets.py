...
RUN_TAGGER_CMD = "java -XX:ParallelGCThreads=2 -Xmx500m -jar ../coreference/ark-tweet-nlp-0.3.2/ark-tweet-nlp-0.3.2.jar"
...
if __name__ == "__main__":
    ...
    if success:
        ...
        tweets = ['this is a message', 'and a second message', '"@American_hero @dfwlibrarian @Manicdj99 @cspanwj access- its a funny craze- saudis are posting vids of themselves doing this in 1000s']
